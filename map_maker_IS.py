...
class maker:
    ...
    def update(self):
        ...
        if (self.mouse_x>=300 and self.mouse_x<=320) and (self.mouse_y>=40 and self.mouse_y<=60) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
            self.selection = 1
        if (self.mouse_x>=325 and self.mouse_x<=345) and (self.mouse_y>=40 and self.mouse_y<=60) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
            self.selection = 2
        if (self.mouse_x>=350 and self.mouse_x<=370) and (self.mouse_y>=40 and self.mouse_y<=60) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
            self.selection = 3
        if (self.mouse_x>=375 and self.mouse_x<=395) and (self.mouse_y>=40 and self.mouse_y<=60) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
            self.selection = 4
        if (self.mouse_x>=400 and self.mouse_x<=420) and (self.mouse_y>=40 and self.mouse_y<=60) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
            self.selection = 5
        if (self.mouse_x>=300 and self.mouse_x<=360) and (self.mouse_y>=70 and self.mouse_y<=90) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
            self.selection = 6
        
        if (self.mouse_x>=20 and self.mouse_x<=276) and (self.mouse_y>=20 and self.mouse_y<=276) and pyxel.btn(pyxel.MOUSE_BUTTON_LEFT)==True:
        ...
        if self.selection == 6 and (self.mouse_x>=20 and self.mouse_x<=276) and (self.mouse_y>=20 and self.mouse_y<=276) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
            self.initial_x = (self.mouse_x-20)//16
            self.initial_y = (self.mouse_y-20)//16
            self.selection = 0
        
        if (self.mouse_x>=440 and self.mouse_x<=480) and (self.mouse_y>=40 and self.mouse_y<=60) and pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT)==True:
    ...
    def draw(self):
        ...
        if self.difficulty == 1:
            pyxel.rect(442,42,16,16,3)
            pyxel.text(448,47, "F", 7)
        elif self.difficulty == 2:
            pyxel.rect(462,42,16,16,8)
            pyxel.text(468,47, "D", 7)
        ...
        pyxel.rectb(300,40,20,20,1) #gelo
        pyxel.blt(302,42,0,16,0,16,16)
        pyxel.rectb(325,40,20,20,1) #gelo grosso
        pyxel.blt(327,42,0,0,0,16,16)
        pyxel.rectb(350,40,20,20,1) #agua
        pyxel.blt(352,42,0,32,0,16,16)
        pyxel.rectb(375,40,20,20,1) #neve
        pyxel.blt(377,42,0,0,64,16,16)
        pyxel.rectb(400,40,20,20,1) #final point
        pyxel.blt(402,42,0,48,32,16,16, 8)
        pyxel.rect(300, 70, 60, 20,3) #setar posição inicial
        pyxel.text(305, 78, "Set init pos", 7)
        ...
        pyxel.text(440,33,"Difficulty",1)
        pyxel.rectb(440,40,40,20,1)
        

        match self.selection:
            case 1:
                pyxel.rectb(300,40,20,20,8)
            case 2:
                pyxel.rectb(325,40,20,20,8)
            case 3:
                pyxel.rectb(350,40,20,20,8)
            case 4:
                pyxel.rectb(375, 40, 20,20,8)
            case 5:
                pyxel.rectb(400,40,20,20,8)
            case 6:
                pyxel.rectb(299,69,62,22,8)
                pyxel.rectb(300,70,60,20,8)
